...
namespace DigitalOpus.MB.Core{
	public class MB3_TextureBakerEditorInternal{
		...
		private SerializedProperty textureBakeResults, maxTilingBakeSize, maxAtlasSize, doMultiMaterial, fixOutOfBoundsUVs, resultMaterial, resultMaterials, atlasPadding, resizePowerOfTwoTextures, customShaderProperties, objsToMesh, texturePackingAlgorithm, forcePowerOfTwoAtlas;
